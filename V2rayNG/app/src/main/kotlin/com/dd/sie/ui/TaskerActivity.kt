...
import com.dd.sie.databinding.ActivityTaskerBinding
...
class TaskerActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //add def value
        lstData.add("Default")
        lstGuid.add(com.dd.sie.AppConfig.TASKER_DEFAULT_GUID)
    ...
    private fun init() {
        try {
            val bundle = intent?.getBundleExtra(com.dd.sie.AppConfig.TASKER_EXTRA_BUNDLE)
            val switch = bundle?.getBoolean(com.dd.sie.AppConfig.TASKER_EXTRA_BUNDLE_SWITCH, false)
            val guid = bundle?.getString(com.dd.sie.AppConfig.TASKER_EXTRA_BUNDLE_GUID, "")
    ...
    private fun confirmFinish() {
        ...
        extraBundle.putBoolean(com.dd.sie.AppConfig.TASKER_EXTRA_BUNDLE_SWITCH, binding.switchStartService.isChecked)
        extraBundle.putString(com.dd.sie.AppConfig.TASKER_EXTRA_BUNDLE_GUID, lstGuid[position])
        val intent = Intent()
        ...
        intent.putExtra(com.dd.sie.AppConfig.TASKER_EXTRA_BUNDLE, extraBundle)
        intent.putExtra(com.dd.sie.AppConfig.TASKER_EXTRA_STRING_BLURB, blurb)
