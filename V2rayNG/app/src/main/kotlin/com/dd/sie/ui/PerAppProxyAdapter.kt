...
import com.dd.sie.R
import com.dd.sie.databinding.ItemRecyclerBypassListBinding
import java.util.*

class PerAppProxyAdapter(val activity: BaseActivity, val apps: List<com.dd.sie.dto.AppInfo>, blacklist: MutableSet<String>?) :
...
//                    .inflate(R.layout.item_recycler_bypass_list, parent, false))
    ...
    inner class AppViewHolder(private val itemBypassBinding: ItemRecyclerBypassListBinding) : BaseViewHolder(itemBypassBinding.root),
        ...
        private lateinit var appInfo: com.dd.sie.dto.AppInfo

        fun bind(appInfo: com.dd.sie.dto.AppInfo) {
