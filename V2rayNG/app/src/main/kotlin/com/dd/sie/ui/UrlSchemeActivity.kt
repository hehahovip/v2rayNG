...
import com.dd.sie.R
import com.dd.sie.databinding.ActivityLogcatBinding
                ...
                if (action == Intent.ACTION_SEND) {
                    if ("text/plain" == type) {
                        intent.getStringExtra(Intent.EXTRA_TEXT)?.let {
                            ...
                            if (uri.scheme?.startsWith(com.dd.sie.AppConfig.HTTPS_PROTOCOL) == true || uri.scheme?.startsWith(
                                    com.dd.sie.AppConfig.HTTP_PROTOCOL
                                ) == true
                            ) {
