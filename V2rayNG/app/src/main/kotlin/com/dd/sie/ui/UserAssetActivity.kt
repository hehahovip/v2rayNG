...
import com.dd.sie.R
import com.dd.sie.databinding.ActivitySubSettingBinding
import com.dd.sie.databinding.ItemRecyclerUserAssetBinding
import com.dd.sie.extension.toTrafficString
...
class UserAssetActivity : BaseActivity() {
    ...
    private fun downloadGeo(name: String, timeout: Int, httpPort: Int): Boolean {
        val url = com.dd.sie.AppConfig.geoUrl + name
        ...
        try {
            ...
            Log.e(com.dd.sie.AppConfig.ANG_PACKAGE, Log.getStackTraceString(e))
            return false
        } finally {
            conn?.disconnect()
        }
