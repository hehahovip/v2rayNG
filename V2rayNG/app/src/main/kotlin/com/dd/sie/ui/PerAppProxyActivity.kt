...
import com.dd.sie.R
import com.dd.sie.databinding.ActivityBypassListBinding
import com.dd.sie.extension.toast
import com.dd.sie.extension.v2RayApplication
import com.dd.sie.util.AppManagerUtil
...
class PerAppProxyActivity : BaseActivity() {
    ...
    private var appsAll: List<com.dd.sie.dto.AppInfo>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val blacklist = defaultSharedPreferences.getStringSet(com.dd.sie.AppConfig.PREF_PER_APP_PROXY_SET, null)
        ...
        AppManagerUtil.rxLoadNetworkAppList(this)
                ...
                .map {
                    if (blacklist != null) {
                        ...
                        val comparator = Comparator<com.dd.sie.dto.AppInfo> { p1, p2 ->
                            when {
                        ...
                        val comparator = object : Comparator<com.dd.sie.dto.AppInfo> {
                            val collator = Collator.getInstance()
                            override fun compare(o1: com.dd.sie.dto.AppInfo, o2: com.dd.sie.dto.AppInfo) = collator.compare(o1.appName, o2.appName)
                        }
                        it.sortedWith(comparator)
                    }
                }
...
//                }
        ...
        binding.switchPerAppProxy.setOnCheckedChangeListener { _, isChecked ->
            defaultSharedPreferences.edit().putBoolean(com.dd.sie.AppConfig.PREF_PER_APP_PROXY, isChecked).apply()
        }
        binding.switchPerAppProxy.isChecked = defaultSharedPreferences.getBoolean(com.dd.sie.AppConfig.PREF_PER_APP_PROXY, false)

        binding.switchBypassApps.setOnCheckedChangeListener { _, isChecked ->
            defaultSharedPreferences.edit().putBoolean(com.dd.sie.AppConfig.PREF_BYPASS_APPS, isChecked).apply()
        }
        binding.switchBypassApps.isChecked = defaultSharedPreferences.getBoolean(com.dd.sie.AppConfig.PREF_BYPASS_APPS, false)
    ...
    override fun onPause() {
        super.onPause()
        adapter?.let {
            defaultSharedPreferences.edit().putStringSet(com.dd.sie.AppConfig.PREF_PER_APP_PROXY_SET, it.blacklist).apply()
        }
    }
    ...
    private fun selectProxyApp() {
        ...
        val url = com.dd.sie.AppConfig.androidpackagenamelistUrl
    ...
    private fun filterProxyApp(content: String): Boolean {
        val apps = ArrayList<com.dd.sie.dto.AppInfo>()
