...
import com.dd.sie.AppConfig.PREF_ALLOW_INSECURE
import com.dd.sie.R
import com.dd.sie.dto.ServerConfig
import com.dd.sie.dto.V2rayConfig
import com.dd.sie.dto.V2rayConfig.Companion.DEFAULT_PORT
import com.dd.sie.dto.V2rayConfig.Companion.TLS
import com.dd.sie.extension.toast
import com.dd.sie.util.MmkvManager
import com.dd.sie.util.MmkvManager.ID_MAIN
...
class ServerActivity : BaseActivity() {
    ...
    private val createConfigType by lazy {
        com.dd.sie.dto.EConfigType.fromInt(intent.getIntExtra("createConfigType", com.dd.sie.dto.EConfigType.VMESS.value)) ?: com.dd.sie.dto.EConfigType.VMESS
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(config?.configType ?: createConfigType) {
            com.dd.sie.dto.EConfigType.VMESS -> setContentView(R.layout.activity_server_vmess)
            com.dd.sie.dto.EConfigType.CUSTOM -> return
            com.dd.sie.dto.EConfigType.SHADOWSOCKS -> setContentView(R.layout.activity_server_shadowsocks)
            com.dd.sie.dto.EConfigType.SOCKS -> setContentView(R.layout.activity_server_socks)
            com.dd.sie.dto.EConfigType.VLESS -> setContentView(R.layout.activity_server_vless)
            com.dd.sie.dto.EConfigType.TROJAN -> setContentView(R.layout.activity_server_trojan)
    ...
    private fun bindingServer(config: ServerConfig): Boolean {
        ...
        if (config.configType == com.dd.sie.dto.EConfigType.SOCKS) {
        ...
        val securityEncryptions = if (config.configType == com.dd.sie.dto.EConfigType.SHADOWSOCKS) shadowsocksSecuritys else securitys
    ...
    private fun saveServer(): Boolean {
        ...
        if (config.configType != com.dd.sie.dto.EConfigType.SOCKS && TextUtils.isEmpty(et_id.text.toString())) {
            toast(R.string.server_lab_id)
            return false
        }
        sp_stream_security?.let {
            if (config.configType == com.dd.sie.dto.EConfigType.TROJAN && TextUtils.isEmpty(streamSecuritys[it.selectedItemPosition])) {
    ...
    private fun deleteServer(): Boolean {
        if (editGuid.isNotEmpty()) {
            if (editGuid != mainStorage?.decodeString(KEY_SELECTED_SERVER)) {
                if (settingsStorage?.decodeBool(com.dd.sie.AppConfig.PREF_CONFIRM_REMOVE) == true) {
