...
import com.dd.sie.databinding.ActivityRoutingSettingsBinding
...
class RoutingSettingsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragments.add(RoutingSettingsFragment().newInstance(com.dd.sie.AppConfig.PREF_V2RAY_ROUTING_AGENT))
        fragments.add(RoutingSettingsFragment().newInstance(com.dd.sie.AppConfig.PREF_V2RAY_ROUTING_DIRECT))
        fragments.add(RoutingSettingsFragment().newInstance(com.dd.sie.AppConfig.PREF_V2RAY_ROUTING_BLOCKED))
