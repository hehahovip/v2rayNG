...
import com.dd.sie.R
import com.dd.sie.databinding.ActivityMainBinding
...
//        toast(R.string.toast_services_start)
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
        ...
        R.id.import_manually_vmess -> {
            importManually(com.dd.sie.dto.EConfigType.VMESS.value)
            true
        }
        R.id.import_manually_vless -> {
            importManually(com.dd.sie.dto.EConfigType.VLESS.value)
            true
        }
        R.id.import_manually_ss -> {
            importManually(com.dd.sie.dto.EConfigType.SHADOWSOCKS.value)
            true
        }
        R.id.import_manually_socks -> {
            importManually(com.dd.sie.dto.EConfigType.SOCKS.value)
            true
        }
        R.id.import_manually_trojan -> {
            importManually(com.dd.sie.dto.EConfigType.TROJAN.value)
            true
        }
...
//    }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.feedback -> {
                Utils.openUri(this, com.dd.sie.AppConfig.v2rayNGIssues)
            }
            R.id.promotion -> {
                Utils.openUri(this, "${Utils.decode(com.dd.sie.AppConfig.promotionUrl)}?t=${System.currentTimeMillis()}")
            }
            R.id.logcat -> {
