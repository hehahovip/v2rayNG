...
public class NetworkHistoryStatHelper {

    NetworkStatsManager networkStatsManager;
    int packageUid;

    public NetworkHistoryStatHelper(NetworkStatsManager networkStatsManager) {
        this.networkStatsManager = networkStatsManager;
    }

    public NetworkHistoryStatHelper(NetworkStatsManager networkStatsManager, int packageUid) {
        this.networkStatsManager = networkStatsManager;
